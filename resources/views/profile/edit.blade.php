                    ...
                    <div class="widget">
                        <h5 class="widget__title">Editar Perfil</h5>
                            ...
                            <form action="{{ route('profile.update') }}" class="widget__form" method="POST">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control widget__form-input" placeholder="Descripción" name="descripcion">{{ old('description', auth()->user()->descripcion) }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="url" class="form-control widget__form-input" placeholder="URL de YouTube" name="urlyoutube" value="{{ old('urlyoutube', auth()->user()->urlyoutube) }}">
                                </div>
